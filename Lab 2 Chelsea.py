...
print("\nExercise 5")
Day_today = int(input("Day_today"))
Days_trip = int(input("Days_trip"))
Mytripstartsonday0lasts4daysIamgoingtobebackonday4 = (Day_today + Days_trip) % 7
print(f"{Mytripstartsonday0lasts4daysIamgoingtobebackonday4}")
