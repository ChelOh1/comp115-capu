...
def remove_duplicates(s):
    """
    This function removes duplicate characters in the string s.
    ...
    Returns:
    - (string): A removed version of string s.
...
def find_index(s, t):
    ...
    Returns:
    - (int): Lowest index of t in s, or -1 if not found.
    """
    r = 0
    for c in s:
        if c == t:
...
def project_completion_day(day, days_to_completion):
    """
    This function calculates the project completion day of the week.
    ...
    Parameters:
    - day (string): Current day of the week.
    - days_to_completion (int): Number of days until project completion.
    
    Returns:
    - (string): Day of week when project will be completed.
    """
    start = days_week.index(day)
    end = (start + days_to_completion)%7
    return days_week[end]
...
# Your unit tests
assert parse_log_line('2024-03-05 14:32:15 [ERROR] database.py Connection timeout after 30s') == (
    '2024-03-05 14:32:15', 'ERROR', 'database.py', 'Connection timeout after 30s')
assert parse_log_line('2024-03-05 14:32:18 [WARNING] api.py Slow query detected (2.3s)') == (
    '2024-03-05 14:32:18', 'WARNING', 'api.py', 'Slow query detected (2.3s)')
assert parse_log_line('2024-03-05 14:32:22 [INFO] server.py Server started on port 8000') == (
    '2024-03-05 14:32:22', 'INFO', 'server.py', 'Server started on port 8000')
